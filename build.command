...
swiftc -O -swift-version 5 -parse-as-library Source/Localization.swift Source/Core.swift Source/Weekly.swift Source/Audit.swift Source/Applications.swift Source/Updates.swift Source/TranslationSupport.swift Source/ApplicationsView.swift Source/MacTidy.swift -o MacTidy.app/Contents/MacOS/MacTidy -framework SwiftUI -framework AppKit -framework CoreServices -Xlinker -weak_framework -Xlinker Translation -target "$(uname -m)-apple-macosx13.0"
mkdir -p MacTidy.app/Contents/Resources
cp Assets/MacTidy.icns MacTidy.app/Contents/Resources/MacTidyGraphite.icns
cp Assets/MacTidy.icns MacTidy.app/Contents/Resources/MacTidy.icns
